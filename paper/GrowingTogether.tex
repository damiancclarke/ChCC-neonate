...
\begin{figure}[ht!]
  \begin{center}
    ...
    \includegraphics[scale=0.9]{../results/ChCCtime.eps}
    \label{fig:coverage}
  \end{center}
  \vspace{-5mm}
...
of the program's action in more depth later in the paper.%, where we
%consider these components one-by-one.
...
%    \citet{BarberGertler2010}& 81.9 (54.2)   & \$279 USD & \$3.40  \\
  ...
  \end{tabular}
\end{table}
    % Add citation for \citet{CurrieRajani2015}.}} \\
...
\begin{landscape}
\input{./tables/comunaDD-trimester.tex}
\end{landscape}
%\begin{figure}[htpb!]
%  \begin{center}
%    \centering
...
%    program roll-out occurred in June of 2007, with the remainder of
%    municipalities joining in the second roll-out in January of 2008.
  ...
  \begin{center}
      \begin{tabular}{lcccccc} \toprule
        ...
        \multicolumn{7}{p{14.8cm}}{{\footnotesize \textsc{Notes}: Corrected $p$-values based
            ...
            control the Family Wise Error Rate of hypothesis tests. The \citet{Anderson2008}
...
\begin{landscape}
\input{./tables/comunaDD-Available.tex}
\end{landscape}
...
\begin{landscape}
  \input{./tables/ChCC_Inputs.tex}
\end{landscape}

\input{./tables/GelbachMechanism.tex}
...
%  \begin{center}
%    \caption{Summary Statistics: Birth and Chile Crece Contigo Data}
%    \label{tab:sumstatsMech}
%    \begin{tabular}{lccccc} \toprule
%      & N& Mean & Std. Dev. & Min & Max \\ \midrule
%      \input{../results/SummaryMechanisms.tex} \midrule
%      \multicolumn{6}{p{14.2cm}}{{\footnotesize \textsc{Notes to Table
%            \ref{tab:sumstatsMech}}: Summary Statistics are displayed for
%          health service by month averages for each mechanism based on
%          usage over the previous 9 months.
%      }} \\ \bottomrule
%      \end{tabular}
%  \end{center}
%\end{table}
...
\input{./tables/motherFE-controls.tex}
